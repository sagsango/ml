...
for col in X_given.columns:
	if( X_given[col].dtype == 'object' and X_given[col].isnull().any() == 0 and X_asked[col].isnull().any() == 0 and set(X_given[col]) == set(X_asked[col]) ):
...
X_given = X_given_copy.copy();
X_asked = X_asked_copy.copy();
#------------------------------#--------------------------#----------------------------------#----------------------------#
...
best_mae = 1e9;
best_nodes = 1e9;
for cur_nodes in range(470,485,1):
...
#best_mae: 17749.193016933506 best_nodes: 633
#best_mae: 17745.244587280016 best_nodes: 482
