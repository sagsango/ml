...
OH_X_given = pd.DataFrame(OH_encoder.fit_transform(X_given[object_col]));
OH_X_asked = pd.DataFrame(OH_encoder.transform(X_asked[object_col]));
OH_X_given.index = X_given.index;
OH_X_asked.index = X_asked.index;
num_X_given = X_given.drop(object_col,axis=1);
num_X_asked = X_asked.drop(object_col,axis=1);
X_given = pd.concat([num_X_given,OH_X_given],axis=1);
X_asked = pd.concat([num_X_asked,OH_X_asked],axis=1);
#------------------------------#--------------------------#----------------------------------#----------------------------#
...
best_mae = 1e9;
best_nodes = 1e9;
for cur_nodes in range(665,675,1):
...
#best_mae: 17736
#best_mae: 18572.956578600926 best_nodes: 74
#best_mae: 18336.270930880295 best_nodes: 92
#best_mae: 17975.327885538816 best_nodes: 195
#best_mae: 17871.162970316676 best_nodes: 470
#best_mae: 17868.86764717009 best_nodes: 670
#best_mae: 17868.73726799798 best_nodes: 665
#####################################               predict 	               ##################################################
